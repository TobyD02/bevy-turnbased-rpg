...
use crate::systems::draw_game_log_system::draw_game_log_system;
...
use crate::systems::spawn_game_log_system::spawn_game_log_system;
...
use crate::systems::spawn_ui_camera_system::spawn_ui_camera_system;
...
fn main() {
    App::new()
        ...
        .add_systems(Startup, (spawn_ui_camera_system, spawn_game_log_system).chain())
        .add_systems(Update, draw_game_log_system)
